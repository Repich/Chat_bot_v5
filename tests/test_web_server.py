...
"""
    ...
    def test_health_and_chat_return_json(self) -> None:
        ...
        self.assertIn("app.js?v=5.0.0-alpha.68", chat_page)
        self.assertIn("workbench.js?v=5.0.0-alpha.68", chat_page)
        self.assertIn("renderers.js?v=5.0.0-alpha.68", chat_page)
        self.assertIn("styles.css?v=5.0.0-alpha.68", chat_page)
